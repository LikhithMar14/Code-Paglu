...
export default function PasswordSignInForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // You'll need to set up credentials provider in your next-auth config
    ...
    >
      {error && (
        <motion.div 
          ...
          className="mb-4 rounded-lg bg-red-500/10 p-3 text-sm font-medium text-red-500 border border-red-500/20"
        >
          {error}
        </motion.div>
      )}
